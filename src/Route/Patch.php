...
/**
 * Route that matches PATCH requests.
 */
final class Patch extends Route
{
    /**
     * Creates a route that matches PATCH requests.
     *
    ...
    {
        parent::__construct([Method::PATCH], $pattern, $name, $action, $middlewares, $defaults, $hosts, $override, $disabledMiddlewares);
    }
}
