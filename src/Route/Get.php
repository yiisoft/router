...
/**
 * Route that matches GET requests.
 */
final class Get extends Route
{
    /**
     * Creates a route that matches GET requests.
     *
    ...
    {
        parent::__construct([Method::GET], $pattern, $name, $action, $middlewares, $defaults, $hosts, $override, $disabledMiddlewares);
    }
}
