...
/**
 * Route that matches DELETE requests.
 */
final class Delete extends Route
{
    /**
     * Creates a route that matches DELETE requests.
     *
    ...
    {
        parent::__construct([Method::DELETE], $pattern, $name, $action, $middlewares, $defaults, $hosts, $override, $disabledMiddlewares);
    }
}
